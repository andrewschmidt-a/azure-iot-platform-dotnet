...
class Balloon extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Dropdown_1.Dropdown, { dropdown: React.createElement(Attributes_1.Elements.span, { className: innerClassName, attr: this.props.attr.balloonContent }, this.props.tooltip), visible: this.state.visible, className: className, positionClassNames: this.props.autoPosition ? positions : [], onMouseEnter: this.onMouseEnter, onMouseLeave: this.onMouseLeave, attr: {
