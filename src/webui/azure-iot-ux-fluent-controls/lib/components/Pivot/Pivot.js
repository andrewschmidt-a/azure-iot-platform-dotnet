...
const StyledPivotBorder = styled_components_1.default(Attributes_1.Elements.div) `
    &&&& {
        ${(props) => props.theme.colorBgBtnPrimaryRest && ('border-bottom: 2px solid' + props.theme.colorBgBtnPrimaryRest)}
    }
`;
exports.Pivot = (props) => {
    let contents;
    ...
    const PivotBorderProxy = props.selected ? StyledPivotBorder : Attributes_1.Elements.div;
    /**
    ...
    return (React.createElement(Attributes_1.Elements.div, { className: css('pivot-container', {
        ...
        contents,
        contents,
        React.createElement(PivotBorderProxy, { className: css('pivot-border'), attr: props.attr.bottomBorder }),
