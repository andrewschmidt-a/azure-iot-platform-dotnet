...
exports.FormLabel = (props) => {
    const balloon = props.balloon
        ? React.createElement(Balloon_1.Balloon, { tooltip: props.balloon, align: props.balloonAlignment || Balloon_1.BalloonAlignment.Start, position: props.balloonPosition || Balloon_1.BalloonPosition.Top, className: css('label-icon'), multiline: true, expanded: props.balloonExpanded, attr: Attributes_1.mergeAttributeObjects(props.attr.balloon, { balloon: {
    ...
    return (React.createElement(Attributes_1.Elements.div, { className: css('label-container', props.className), attr: props.attr.container },
        React.createElement(Attributes_1.Elements.div, { className: css('label-inner-container'), attr: props.attr.innerContainer },
            ...
            balloon),
        props.farSide && React.createElement(Attributes_1.Elements.div, { className: css('label-farSide-container'), attr: props.attr.farSideContainer }, props.farSide)));
};
