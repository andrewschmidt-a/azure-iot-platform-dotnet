...
exports.ActionTrigger = (props) => {
    ...
    return (React.createElement(Attributes_1.Elements.div, { className: className, attr: props.attr && props.attr.container || {} },
        React.createElement(Icon_1.Icon, { icon: props.icon, labelClassName: css('action-trigger-label'), size: Icon_1.IconSize.xsmall, attr: props.attr && props.attr.icon || {} }, props.label),
        suffix));
};
