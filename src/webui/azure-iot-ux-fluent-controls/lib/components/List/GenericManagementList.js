    ...
    render() {
        ...
        this.props.columns.forEach((column, colIndex) => {
            ...
            if (sortable) {
                ...
                columns[colIndex].push(React.createElement(Attributes_1.Elements.button, { type: 'button', className: css('column-header'), key: `header-${colIndex}`, onClick: onClick, attr: this.props.attr.rowHeaderButton },
                    column.label,
                    labelSuffix));
            }
            else {
                ...
                columns[colIndex].push(React.createElement(Attributes_1.Elements.header, { className: css('column-header'), key: `header-${colIndex}`, attr: this.props.attr.rowHeaderButton }, column.label));
            }
