...
const StyledActiveCheckboxButton = styled_components_1.default(Attributes_1.Elements.span) `
    &&&& {
...
exports.CheckboxInput = (props) => {
    ...
    const CheckboxInputProxy = props.checked ? StyledActiveCheckboxButton : Attributes_1.Elements.span;
    return (React.createElement(Attributes_1.Elements.div, { className: containerClass, hidden: props.hidden, attr: props.attr.container },
        React.createElement(Attributes_1.Elements.label, { className: css('checkbox-label'), htmlFor: id, onClick: stopPropagation, attr: props.attr.label },
            ...
            React.createElement(CheckboxInputProxy, { className: css('checkbox-button'), attr: props.attr.checkbox }),
            ...
            React.createElement(styled_components_1.ThemeConsumer, null, theme => React.createElement(Icon_1.Icon, { icon: 'checkMark', size: Icon_1.IconSize.xsmall, className: css('checkbox-checkmark'), attr: props.attr.checkmarkIcon, color: theme && theme.colorTextBtnPrimaryRest })))));
};
