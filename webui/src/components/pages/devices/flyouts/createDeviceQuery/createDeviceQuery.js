...
export class CreateDeviceQuery extends LinkedComponent {
  ...
  onCloseFlyout = () => {
    this.props.logEvent(toDiagnosticsModel('CreateDeviceQuery_TopXCloseClick', {}));
  ...
  render() {
    ...
    return (
      <Flyout.Container header={t('createDeviceQueryFlyout.title')} t={t} onClose={this.onCloseFlyout}>
