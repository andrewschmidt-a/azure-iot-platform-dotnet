...
class Calendar extends React.Component {
    ...
    componentDidUpdate() {
        if (this.nextFocusRow != null && this.nextFocusCol != null) {
            const nextFocus = this._container.querySelectorAll(`[data-row="${this.nextFocusRow}"][data-col="${this.nextFocusCol}"]`)[0];
            if (nextFocus != null) {
                nextFocus.focus();
            }
    ...
    onKeyDown(e) {
        ...
        if (!isNaN(row) && !isNaN(col)) {
            ...
            nextFocus = this._container.querySelectorAll(`[data-row="${nextRow}"][data-col="${nextCol}"]`)[0];
    ...
    render() {
        ...
        const content = rows.map((row, rowIndex) => {
            let inner = row.map((col, colIndex) => {
                ...
                if (colMonth !== curMonth) {
                    return (React.createElement(Attributes_1.Elements.button, { type: 'button', "aria-label": ariaLabel, "data-row": rowIndex, "data-col": colIndex, onKeyDown: this.onKeyDown, className: colClassName, onClick: onClick, key: key, attr: this.props.attr.dateButton }, date));
                }
                /** Selected day */
                if (this.props.value) {
                    ...
                    if (isSelected) {
                        return (React.createElement(Attributes_1.Elements.button, { type: 'button', "aria-label": ariaLabel, "data-row": rowIndex, "data-col": colIndex, onKeyDown: this.onKeyDown, className: css('selected'), onClick: onClick, key: key, attr: this.props.attr.dateButton }, date));
                    }
                }
                /** Everything else */
                return (React.createElement(Attributes_1.Elements.button, { type: 'button', "aria-label": ariaLabel, "data-row": rowIndex, "data-col": colIndex, onKeyDown: this.onKeyDown, onClick: onClick, key: key, attr: this.props.attr.dateButton }, date));
            });
        ...
        return (React.createElement(Attributes_1.Elements.div, { methodRef: this.setContainerRef, className: css('calendar', this.props.className), attr: this.props.attr.container },
            React.createElement(Attributes_1.Elements.div, { className: css('calendar-header'), attr: this.props.attr.header },
                ...
                React.createElement("div", { className: css('action-bar') },
                    React.createElement(ActionTriggerButton_1.ActionTriggerButton, { className: css('calendar-chevron'), onClick: this.onPrevMonth, icon: 'chevronUp', attr: this.props.attr.prevMonthButton }),
                    React.createElement(ActionTriggerButton_1.ActionTriggerButton, { icon: 'chevronDown', className: css('calendar-chevron'), onClick: this.onNextMonth, attr: this.props.attr.nextMonthButton }))),
