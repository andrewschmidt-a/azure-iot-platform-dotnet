...
class DateTimeField extends React.Component {
    ...
    render() {
        ...
        const timeAttr = Object.assign({ hourSelect: Object.assign({ 'aria-describedby': describedby }, (this.props.attr.timeInput && this.props.attr.timeInput.hourSelect)), minuteSelect: Object.assign({ 'aria-describedby': describedby }, (this.props.attr.timeInput && this.props.attr.timeInput.minuteSelect)), secondSelect: Object.assign({ 'aria-describedby': describedby }, (this.props.attr.timeInput && this.props.attr.timeInput.secondSelect)), periodSelect: Object.assign({ 'aria-describedby': describedby }, (this.props.attr.timeInput && this.props.attr.timeInput.periodSelect)) }, (this.props.attr.timeInput && this.props.attr.timeInput));
        const fieldAttr = {
        ...
        return (React.createElement(FormField_1.FormField, { name: this.props.name, label: this.props.label, error: this.props.error, errorTitle: this.props.errorTitle, loading: this.props.loading, required: this.props.required, hideError: this.props.hideError, className: css('datetime-field', this.props.className), attr: fieldAttr, tooltip: this.props.tooltip, labelFarSide: this.props.labelFarSide },
            React.createElement(Attributes_1.Elements.div, { className: css('field-content'), attr: this.props.attr.flexContainer },
                React.createElement(Attributes_1.Elements.span, { className: css('field-date'), attr: this.props.attr.dateColumn },
                    React.createElement(DatePicker_1.DatePicker, { name: this.props.name, initialValue: this.state.initialDate, tabIndex: this.props.tabIndex, error: !!this.props.error, disabled: this.props.disabled, locale: this.props.locale, localTimezone: this.props.localTimezone, showAbove: this.props.showAbove, format: this.props.format, required: this.props.required, onPaste: this.onDatePaste, onChange: this.onDateChange, onExpand: this.props.onExpand, className: css('date-picker', this.props.inputClassName), attr: dateAttr })),
                React.createElement(Attributes_1.Elements.span, { className: css('field-time'), attr: this.props.attr.timeColumn },
                    React.createElement(TimeInput_1.TimeInput, { name: this.props.name, value: this.state.lastTime, amLabel: this.props.amLabel, pmLabel: this.props.pmLabel, localTimezone: this.props.localTimezone, showSeconds: this.props.showSeconds, militaryTime: this.props.militaryTime, error: !!this.props.error, disabled: this.props.disabled, onChange: this.onTimeChange, className: css('time-picker', this.props.inputClassName), attr: timeAttr })))));
    }
}
