...
exports.CheckboxField = (props) => {
    ...
    return (React.createElement(FormField_1.FormField, { name: props.name, label: props.label, error: props.error, errorTitle: props.errorTitle, loading: props.loading, required: props.required, tooltip: props.tooltip, className: props.className, attr: fieldAttr, labelFarSide: props.labelFarSide },
        React.createElement("div", null,
            React.createElement(CheckboxInput_1.CheckboxInput, { name: props.name, checked: props.value, label: props.label, disabled: props.disabled, onChange: props.onChange, className: props.inputClassName, autoFocus: props.autoFocus, required: props.required, attr: checkboxAttr }))));
};
