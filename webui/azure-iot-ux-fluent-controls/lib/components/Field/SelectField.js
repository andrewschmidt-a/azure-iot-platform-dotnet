...
exports.SelectField = (props) => {
    ...
    return (React.createElement(FormField_1.FormField, { name: props.name, label: props.label, error: props.error, errorTitle: props.errorTitle, loading: props.loading, required: props.required, tooltip: props.tooltip, className: props.className, attr: fieldAttr, labelFarSide: props.labelFarSide },
        React.createElement(SelectInput_1.SelectInput, { name: props.name, value: props.value, options: props.options, error: !!props.error, disabled: props.disabled, onChange: props.onChange, className: props.inputClassName, autoFocus: props.autoFocus, required: props.required, attr: selectAttr })));
};
