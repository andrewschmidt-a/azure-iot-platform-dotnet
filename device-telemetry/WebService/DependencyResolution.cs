...
namespace Mmm.Platform.IoT.DeviceTelemetry.WebService
{
    public class DependencyResolution : DependencyResolutionBase
    {
        protected override void SetupCustomRules(ContainerBuilder builder, ILogger logger, IHttpClient httpClient)
        {
            ...
            builder.RegisterInstance(config.ServicesConfig).As<IStorageClientConfig>().SingleInstance();
            builder.RegisterInstance(config.ServicesConfig).As<ITimeSeriesClientConfig>().SingleInstance();
